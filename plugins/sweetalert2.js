!function(t, e) {
    ...
    function mt(t, e) {
        var n, o, i, r, a = q(), s = D(), c = T(), u = L(), l = I();
        e.showConfirmButton || e.showDenyButton || e.showCancelButton || rt(a),
        F(a, e, "actions"),
        At(c, "confirm", e),
        At(u, "deny", e),
        At(l, "cancel", e),
        ...
        o = u,
        i = l,
        (r = e).buttonsStyling ? (gt([n, o, i], $.styled),
        ...
        r.cancelButtonColor && (i.style.backgroundColor = r.cancelButtonColor)) : vt([n, o, i], $.styled),
        e.reverseButtons && (a.insertBefore(l, s),
        a.insertBefore(u, s),
        a.insertBefore(c, s)),
        s.innerHTML = e.loaderHtml,
        F(s, e, "loader")
    }
    ...
    function Rt(t, e) {
        ...
        n = t,
        t = e,
        (n = St.innerParams.get(n)) && t.icon === n.icon && B() ? Ft(B(), t) : (_t(),
        t.icon && (-1 !== Object.keys(J).indexOf(t.icon) ? (n = k(".".concat($.icon, ".").concat(J[t.icon])),
        it(n),
        Wt(n, t),
        Ft(n, t),
        gt(n, t.showClass.icon)) : W('Unknown icon! Expected "success", "error", "warning", "info" or "question", got "'.concat(t.icon, '"')))),
        function(t) {
            var e = E();
            if (!t.imageUrl)
                return rt(e);
    ...
    var je = function(t, e) {
      ...
      , Ke = function(t, e, n) {
        ...
        e.inputValidator ? Ye(t, e, o) : t.getInput().checkValidity() ? ("deny" === n ? Ze : Qe)(t, e, o) : (t.enableButtons(),
      ...
      , Ge = function(t, e, n) {
        ...
        "Enter" === e.key ? tn(t, e, o) : "Tab" === e.key ? en(e, o) : -1 !== [].concat($e, Je).indexOf(e.key) ? nn(e.key) : -1 !== Xe.indexOf(e.key) && on(e, o, n)
    }
      , tn = function(t, e, n) {
      ...
      , en = function(t, e) {
        ...
        t.shiftKey ? qe(0, i, -1) : qe(0, i, 1),
        t.stopPropagation(),
        t.preventDefault()
    }
      , nn = function(t) {
        -1 !== [T(), L(), I()].indexOf(document.activeElement) && (t = -1 !== $e.indexOf(t) ? "nextElementSibling" : "previousElementSibling",
    ...
    function dn(a, s, c) {
        return new Promise(function(t) {
            ...
            r = s,
            t = e,
            St.innerParams.get(n).toast ? rn(n, r, t) : (sn(r),
            cn(r),
            un(n, r, t)),
            o = a,
            r = c,
    ...
    Object.keys(Q).forEach(function(t) {
        Cn[t] = function() {
            if (bn)
                return bn[t].apply(bn, arguments)
        }
    }),
    Cn.DismissReason = Z,
    Cn.version = "10.10.2";
